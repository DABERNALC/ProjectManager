...
export const refreshUserData = (payload) => {
  return (dispatch) => {
  ...
  return (dispatch) => {
    ...
    axiosFirebaseAuth
      ...
      .then((response) => {
        ...
        axiosApi
          .post("/teams/createParticipant", params)
          .then((resp) => {
